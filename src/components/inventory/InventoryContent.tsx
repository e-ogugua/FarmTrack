...
export default React.memo(function InventoryContent() {
  ...
  const lowStockItems = useMemo(() =>
    inventory.filter(item => item.quantity <= item.minimumStock && item.minimumStock > 0),
    [inventory]
  );
