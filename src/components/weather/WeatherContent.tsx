...
interface WeatherContentProps {
  ...
  add: <T>(storeName: 'activities' | 'inventory' | 'sales' | 'expenses' | 'labour' | 'weather' | 'tax-records', item: Omit<T, 'id'>) => Promise<unknown>;
  setWeather: (weather: WeatherData | null) => void;
}

export default React.memo(function WeatherContent({
  weather,
  location,
  setLocation,
  loading,
  ...
  }, [setLoading, setError, setWeather, add]);
